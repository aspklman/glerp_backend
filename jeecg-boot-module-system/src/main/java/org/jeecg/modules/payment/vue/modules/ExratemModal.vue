    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="主币别">
          <a-input placeholder="请输入主币别" v-decorator="['mainCoinKind', validatorRules.mainCoinKind ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="换算币别">
          <a-input placeholder="请输入换算币别" v-decorator="['exchCoinKind', validatorRules.exchCoinKind ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="生效年月">
          <a-input placeholder="请输入生效年月" v-decorator="['validDate', validatorRules.validDate ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="汇率">
          <a-input placeholder="请输入汇率" v-decorator="['exchRate', validatorRules.exchRate ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
