        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="主币别">
              <a-input placeholder="请输入主币别" v-model="queryParam.mainCoinKind"></a-input>
            </a-form-item>
          </a-col>
        <template v-if="toggleSearchStatus">
        <a-col :md="6" :sm="8">
            <a-form-item label="换算币别">
              <a-input placeholder="请输入换算币别" v-model="queryParam.exchCoinKind"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        columns: [
          {
           ...
           },
		   {
            title: '主币别',
            align:"center",
            dataIndex: 'mainCoinKind'
           },
		   {
            title: '换算币别',
            align:"center",
            dataIndex: 'exchCoinKind'
           },
		   {
            title: '生效年月',
            align:"center",
