    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="线长度">
              <a-input placeholder="请输入线长度" v-model="queryParam.lineLength"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="MFG_LT">
              <a-input placeholder="请输入MFG_LT" v-model="queryParam.mfgLt"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
