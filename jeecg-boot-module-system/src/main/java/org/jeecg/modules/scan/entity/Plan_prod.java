...
@ApiModel(value="plan_prod对象", description="成型目标产量(新材)表")
public class Plan_prod {
	...
	private java.math.BigDecimal fpyGoal;
	/**产线组长*/
	...
	/**PPH目标*/
	@Excel(name = "PPH目标", width = 15)
    @ApiModelProperty(value = "PPH目标")
