    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="组别编号">
          <a-input placeholder="请输入组别编号" v-decorator="['secNo', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="目标产量达成率">
          <a-input placeholder="请输入目标产量达成率" v-decorator="['achieveRate', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="目标B品数">
          <a-input placeholder="请输入目标B品数" v-decorator="['bGrade', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="目标返修数">
          <a-input placeholder="请输入目标返修数" v-decorator="['rework', {}]" />
        </a-form-item>
