<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <sampleInspectStd-modal ref="modalForm" @ok="modalFormOk"></sampleInspectStd-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/order/sampleInspectStd/list",
          delete: "/order/sampleInspectStd/delete",
          deleteBatch: "/order/sampleInspectStd/deleteBatch",
          exportXlsUrl: "order/sampleInspectStd/exportXls",
          importExcelUrl: "order/sampleInspectStd/importExcel",
       },
    }
  },
  computed: {
