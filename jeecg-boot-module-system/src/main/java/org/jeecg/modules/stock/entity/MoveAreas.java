...
@ApiModel(value="s_stockm对象", description="成品移库")
public class MoveAreas {
    
	/**成品库存主表ID*/
	@TableId(type = IdType.UUID)
    @ApiModelProperty(value = "成品库存主表ID")
	...
	/**存放区域流水号*/
	@Excel(name = "存放区域流水号", width = 15)
    @ApiModelProperty(value = "存放区域流水号")
	private java.lang.String locateSeq;
	/**现在库存量*/
