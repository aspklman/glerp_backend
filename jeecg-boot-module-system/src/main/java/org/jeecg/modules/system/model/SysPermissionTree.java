...
//	private String titleEn;				//增加英文菜单
//	private String titleVn;				//增加越文菜单
...
//	 * 菜单名称(英文)
//	 */
//	private String nameEn;			//增加英文菜单
//
//	/**
//	 * 菜单名称(越文)
//	 */
//	private String nameVn;			//增加越文菜单
...
//		this.nameEn = permission.getNameEn();			//增加英文菜单
//		this.nameVn = permission.getNameVn();			//增加越文菜单
...
//		this.titleEn=permission.getNameEn();			//增加英文菜单
//		this.titleVn=permission.getNameVn();			//增加越文菜单
...
//	public String getTitleEn() {			//增加英文菜单
//		return titleEn;
//	}
//	public String getTitleVn() {			//增加越文菜单
//		return titleVn;
//	}
...
//	public void setTitleEn(String titleEn) {			//增加英文菜单
//		this.titleEn = titleEn;
//	}
//	public void setTitleVn(String titleVn) {			//增加越文菜单
...
//	public String getNameEn() {			//增加英文菜单
//		return nameEn;
//	}
//	public String getNameVn() {			//增加越文菜单
//		return nameVn;
//	}
...
//	public void setNameEn(String nameEn) {			//增加英文菜单
//		this.nameEn = nameEn;
//	}
//	public void setNameVn(String nameVn) {			//增加越文菜单
//		this.nameVn = nameVn;
//	}
