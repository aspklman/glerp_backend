 ...
 * @Description: 资产中分类表
 * @Author: jeecg-boot
 * @Date:   2023-04-23 14:00:58
 * @Version: V1.0
 */
@Data
@TableName("basic_mid_kind")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="basic_mid_kind对象", description="资产中分类表")
public class BasicMidKind {
	...
	private java.lang.Integer depreciationYears;
	/**残值率*/
	@Excel(name = "残值率", width = 15)
    @ApiModelProperty(value = "残值率")
	private java.lang.Integer residualValueRate;
	/**备注*/
